...
void AInventoryCharacter::Tick(float DeltaTime)
{
	...
	if (!MovementInput.IsZero())
	{
		...
		//GEngine->AddOnScreenDebugMessage(-1, 1, FColor::Red, FString::Printf(TEXT("x - %f, y - %f, z - %f"),
...
void AInventoryCharacter::NotifyHit(UPrimitiveComponent* MyComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
